...
class ReviewCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('name')->label("Tên người review");
        CRUD::column('photo')->type("image")->label("Ảnh đính kèm");
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('name')->label("Tên người review");
        CRUD::field('content')->label("Nội dung")->value("Để trống cũng được");
        CRUD::addField([
            'name'      => 'photo', // The db column name
            'label'     => 'Ảnh review', // Table column heading
            'type'      => 'image',
            'crop' => true,
            'aspect_ratio' => 1,
        ]);
